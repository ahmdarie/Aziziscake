            ...
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="mt-2">
                            @if($product->image)
                            <img src="{{ asset('storage/'.$product->image) }}" class="rounded-2" style="max-height:150px">
                            @endif
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-primary"><i class="bi bi-check2 me-2"></i>Update Produk</button>
